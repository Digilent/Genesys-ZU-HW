proc getPresetInfo {} {
  return [dict create name {Genesys ZU -5EV rev A, 2133Mbps} description {Genesys ZU -5EV rev A, 2133Mbps}  vlnv xilinx.com:ip:zynq_ultra_ps_e:3.3 display_name {Genesys ZU -5EV rev A, 2133Mbps} ]
}
