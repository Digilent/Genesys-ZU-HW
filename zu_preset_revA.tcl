proc getPresetInfo {} {
  return [dict create name {Genesys ZU -2CG, 30MHz, 4GB} description {Genesys ZU -2CG, 30MHz, 4GB}  vlnv xilinx.com:ip:zynq_ultra_ps_e:3.3 display_name {Genesys ZU -2CG, 30MHz, 4GB} ]
}
