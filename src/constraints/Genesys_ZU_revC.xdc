...
set_property -dict {PACKAGE_PIN H11    IOSTANDARD LVCMOS18} [get_ports {syzygy_detectn_tri_i[0]}];      #IO_L3P_AD13P_45/25 Sch=syzygy_detectedn
...
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33   PULLUP false   DRIVE 4 } [get_ports IIC_DNA_scl_io];  #IO_L9P_AD3P_46/26 Sch=mux_scl_ls
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33   PULLUP false   DRIVE 4 } [get_ports IIC_DNA_sda_io]; #IO_L9N_AD3N_46/26 Sch=mux_sda_ls
