...
set_property PULLUP false [get_ports hdmi_rx_scl_io]
set_property PULLUP false [get_ports hdmi_rx_sda_io]
set_property DRIVE 4 [get_ports hdmi_rx_scl_io]
set_property DRIVE 4 [get_ports hdmi_rx_sda_io]
set_property SLEW SLOW [get_ports hdmi_rx_scl_io]
set_property SLEW SLOW [get_ports hdmi_rx_sda_io]
...
set_property PULLUP false [get_ports hdmi_tx_i2c_src_scl_tri_io]
set_property PULLUP false [get_ports hdmi_tx_i2c_src_sda_tri_io]
