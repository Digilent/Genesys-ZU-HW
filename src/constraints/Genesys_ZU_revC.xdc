...
set_property PULLUP false [get_ports hdmi_rx_ddc_scl_io]
set_property PULLUP false [get_ports hdmi_rx_ddc_sda_io]
set_property DRIVE 4 [get_ports hdmi_rx_ddc_scl_io]
set_property DRIVE 4 [get_ports hdmi_rx_ddc_sda_io]
set_property SLEW SLOW [get_ports hdmi_rx_ddc_scl_io]
set_property SLEW SLOW [get_ports hdmi_rx_ddc_sda_io]
...
set_property PULLUP false [get_ports hdmi_tx_i2c_scl_io]
set_property PULLUP false [get_ports hdmi_tx_i2c_sda_io]
...
set_property SLEW SLOW [get_ports hdmi_tx_i2c_scl_io]
set_property SLEW SLOW [get_ports hdmi_tx_i2c_sda_io]
