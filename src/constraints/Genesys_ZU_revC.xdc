...
set_property IOSTANDARD DIFF_HSTL_I_DCI_12 [get_ports hdmi_tx_clk_c_p]
set_property IOSTANDARD DIFF_HSTL_I_DCI_12 [get_ports hdmi_tx_clk_c_n]
set_property PACKAGE_PIN C1 [get_ports hdmi_tx_clk_c_p]
set_property PACKAGE_PIN B1 [get_ports hdmi_tx_clk_c_n]
...
set_property PACKAGE_PIN V5 [get_ports mgtrefclk1_pad_n_in_0]
set_property PACKAGE_PIN V6 [get_ports mgtrefclk1_pad_p_in_0]
set_property PACKAGE_PIN Y5 [get_ports mgtrefclk0_pad_n_in_0]
set_property PACKAGE_PIN Y6 [get_ports mgtrefclk0_pad_p_in_0]
...
set_property PACKAGE_PIN C3 [get_ports hdmi_rec_clk_p]
set_property PACKAGE_PIN C2 [get_ports hdmi_rec_clk_n]
set_property OUTPUT_IMPEDANCE RDRV_48_48 [get_ports hdmi_rec_clk_n]
set_property SLEW FAST [get_ports hdmi_rec_clk_n]

## HDMI RX Auxiliary
set_property IOSTANDARD LVCMOS18 [get_ports hdmi_rx_ddc_scl_io]
set_property IOSTANDARD LVCMOS18 [get_ports hdmi_rx_ddc_sda_io]
#set_property PULLUP true [get_ports hdmi_rx_scl_io]
#set_property PULLUP true [get_ports hdmi_rx_sda_io]
set_property PACKAGE_PIN F11 [get_ports hdmi_rx_ddc_scl_io]
set_property PACKAGE_PIN E10 [get_ports hdmi_rx_ddc_sda_io]
set_property PACKAGE_PIN A3 [get_ports hdmi_rx_5v_detn]
set_property IOSTANDARD LVCMOS12 [get_ports hdmi_rx_5v_detn]
set_property PACKAGE_PIN F3 [get_ports hdmi_rx_hpd]
...
set_property PACKAGE_PIN G3 [get_ports {hdmi_tx_oe[0]}]
set_property IOSTANDARD LVCMOS12 [get_ports {hdmi_tx_oe[0]}]
set_property DRIVE 6 [get_ports {hdmi_tx_oe[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_tx_i2c_scl_io]
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_tx_i2c_sda_io]
#set_property PULLUP true [get_ports hdmi_tx_i2c_src_scl_tri_io]
#set_property PULLUP true [get_ports hdmi_tx_i2c_src_sda_tri_io]
set_property PACKAGE_PIN H14 [get_ports hdmi_tx_i2c_scl_io]
set_property PACKAGE_PIN H13 [get_ports hdmi_tx_i2c_sda_io]
set_property DRIVE 4 [get_ports hdmi_tx_i2c_scl_io]
set_property DRIVE 4 [get_ports hdmi_tx_i2c_sda_io]
...
set_property PACKAGE_PIN K13 [get_ports {dp_aux_doe[0]}]
...
##PMOD JD
set_property -dict {PACKAGE_PIN E15 IOSTANDARD LVCMOS33} [get_ports UART_CTL_rxd]
set_property -dict {PACKAGE_PIN A14 IOSTANDARD LVCMOS33} [get_ports UART_CTL_txd]
...
#set_property PACKAGE_PIN E14 [get_ports {hdmi_tx_i2c_src_scl_io}];   #IO_L1N_AD15N_44/24 Sch=jd[7]
#set_property PACKAGE_PIN B14 [get_ports {hdmi_tx_i2c_src_sda_io}];   #IO_L4N_AD12N_44/24 Sch=jd[8]
#set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_tx_i2c_src_scl_io}];
#set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_tx_i2c_src_sda_io}];
...
## Buttons
set_property -dict {PACKAGE_PIN A12 IOSTANDARD LVCMOS18} [get_ports {pl_buttons_tri_i[0]}]
set_property -dict {PACKAGE_PIN F12 IOSTANDARD LVCMOS18} [get_ports {pl_buttons_tri_i[1]}]
set_property -dict {PACKAGE_PIN J12 IOSTANDARD LVCMOS18} [get_ports {pl_buttons_tri_i[2]}]
set_property -dict {PACKAGE_PIN H12 IOSTANDARD LVCMOS18} [get_ports {pl_buttons_tri_i[3]}]
set_property -dict {PACKAGE_PIN B10 IOSTANDARD LVCMOS18} [get_ports {pl_buttons_tri_i[4]}]

## Switches
set_property -dict {PACKAGE_PIN AB15 IOSTANDARD LVCMOS33} [get_ports {pl_switches_tri_i[0]}]
set_property -dict {PACKAGE_PIN W12 IOSTANDARD LVCMOS33} [get_ports {pl_switches_tri_i[1]}]
set_property -dict {PACKAGE_PIN Y13 IOSTANDARD LVCMOS33} [get_ports {pl_switches_tri_i[2]}]
...
set_property -dict {PACKAGE_PIN B9 IOSTANDARD LVCMOS12} [get_ports {pl_rgb_led[1]}]
set_property -dict {PACKAGE_PIN C9 IOSTANDARD LVCMOS12} [get_ports {pl_rgb_led[2]}]
...
set_property PACKAGE_PIN D6 [get_ports clkgth_loln_ls]
...
set_property -dict {IOSTANDARD LVCMOS12} [get_ports clkgth_loln_ls]

## MUX I2C
set_property -dict {PACKAGE_PIN F6 IOSTANDARD LVCMOS12 DRIVE 6} [get_ports {gpio_emio_tri_io[0]}]
set_property PACKAGE_PIN G15 [get_ports mux_scl_io]
set_property PACKAGE_PIN G14 [get_ports mux_sda_io]
