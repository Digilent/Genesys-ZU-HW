...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {85} \
    ...
    CONFIG.CLKOUT2_REQUESTED_PHASE {100.000} \
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ZmodAWGController_0/DAC_InIO_Clk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins counter_0/clk] [get_bd_pins ZmodAwgAxiConfigurat_0/DAC_InIO_Clk] [get_bd_pins set_vadj_and_delay_0/clk]
